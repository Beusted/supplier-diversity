...
<style>
    ...
    .setting-item {{
        ...
        align-items: center;
        padding: 1rem 0;
        border-bottom: 1px solid rgba(196, 146, 20, 0.2);
        color: {theme['text_primary']};
    }}
...
<div class="nav-bar">
    ...
    <div class="nav-buttons">
        <button class="nav-btn {'active' if st.session_state.current_page == 'dashboard' else ''}" onclick="navigateTo('dashboard')">
        ...
        <button class="nav-btn {'active' if st.session_state.current_page == 'about' else ''}" onclick="navigateTo('about')">
...
# Settings Modal (only show if settings are open)
        ...
        <div class="settings-content">
            ...
            <div class="setting-item">
                <div>
                    ...
                    <p style="font-size: 0.9rem; margin: 0; opacity: 0.8;">Toggle between light and dark themes</p>
                </div>
                <div class="toggle-switch {'active' if st.session_state.dark_mode else ''}" onclick="toggleDarkMode()">
            ...
            <div class="setting-item">
                <div>
                    ...
                    <p style="font-size: 0.9rem; margin: 0; opacity: 0.8;">Enable or disable notifications</p>
                </div>
                <div class="toggle-switch {'active' if st.session_state.notifications else ''}" onclick="toggleNotifications()">
                    <div class="toggle-slider"></div>
                </div>
            </div>
        </div>
...
# Handle navigation with Streamlit buttons (fallback for JavaScript)
...
def render_about_page():
    ...
    <div class="dashboard-card">
        <h1 style="margin: 0; text-align: center; color: {theme['text_primary']} !important; font-size: 4rem; font-weight: 800; line-height: 1.1; letter-spacing: -0.02em;">About Our Mission</h1>
        <p style="text-align: center; margin-top: 1rem; font-size: 1.3rem; color: {theme['text_secondary']};">
    ...
    <div class="dashboard-card">
        ...
        <p style="font-size: 1.1rem; line-height: 1.6; color: {theme['text_primary']};">
    ...
    with col1:
        st.markdown(f"""
        <div class="dashboard-card">
            <h2 style="color: var(--mustard-gold); margin-bottom: 1rem;">🏢 Organizations We Serve</h2>
            <ul style="font-size: 1.1rem; line-height: 1.6; color: {theme['text_primary']};">
                <li><strong>Universities & Educational Institutions</strong> - Meeting diversity procurement mandates</li>
                <li><strong>Government Agencies</strong> - Achieving small business contracting goals</li>
                <li><strong>Large Corporations</strong> - Implementing supplier diversity programs</li>
                <li><strong>Non-Profit Organizations</strong> - Supporting community economic development</li>
            </ul>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col2:
        st.markdown(f"""
        <div class="dashboard-card">
            <h2 style="color: var(--mustard-gold); margin-bottom: 1rem;">🏪 Small Businesses We Support</h2>
            <ul style="font-size: 1.1rem; line-height: 1.6; color: {theme['text_primary']};">
                <li><strong>Minority-Owned Businesses</strong> - Expanding market opportunities</li>
                <li><strong>Women-Owned Enterprises</strong> - Breaking into new markets</li>
                <li><strong>Veteran-Owned Companies</strong> - Leveraging procurement preferences</li>
                <li><strong>Local Small Businesses</strong> - Strengthening community economies</li>
            </ul>
        </div>
        """, unsafe_allow_html=True)
    ...
    st.markdown(f"""
    <div class="dashboard-card">
        <h2 style="color: var(--mustard-gold); margin-bottom: 1rem;">🌟 Our Positive Impact</h2>
        
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 2rem; margin-top: 2rem;">
            <div style="background: rgba(196, 146, 20, 0.1); padding: 1.5rem; border-radius: 8px; border-left: 4px solid var(--mustard-gold);">
                <h3 style="color: var(--mustard-gold); margin-bottom: 0.5rem;">For Small Business Owners</h3>
                <ul style="color: {theme['text_primary']}; line-height: 1.6;">
                    <li>Increased revenue through new contract opportunities</li>
                    <li>Access to larger, more stable clients</li>
                    <li>Business growth and expansion possibilities</li>
                    <li>Enhanced credibility and market presence</li>
                </ul>
            </div>
            
            <div style="background: rgba(21, 71, 52, 0.1); padding: 1.5rem; border-radius: 8px; border-left: 4px solid var(--poly-green);">
                <h3 style="color: var(--poly-green); margin-bottom: 0.5rem;">For Communities</h3>
                <ul style="color: {theme['text_primary']}; line-height: 1.6;">
                    <li>Job creation and economic development</li>
                    <li>Increased local spending and tax revenue</li>
                    <li>Strengthened community resilience</li>
                    <li>Reduced economic inequality</li>
                </ul>
            </div>
            
            <div style="background: rgba(220, 20, 60, 0.1); padding: 1.5rem; border-radius: 8px; border-left: 4px solid #DC143C;">
                <h3 style="color: #DC143C; margin-bottom: 0.5rem;">For Organizations</h3>
                <ul style="color: {theme['text_primary']}; line-height: 1.6;">
                    <li>Achievement of diversity procurement goals</li>
                    <li>Compliance with regulatory requirements</li>
                    <li>Enhanced corporate social responsibility</li>
                    <li>Innovation through diverse supplier networks</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="dashboard-card" style="text-align: center;">
        <h2 style="color: var(--mustard-gold); margin-bottom: 1rem;">🚀 Join Our Mission</h2>
        <p style="font-size: 1.2rem; line-height: 1.6; color: {theme['text_primary']}; margin-bottom: 2rem;">
            Together, we can create a more equitable and prosperous economy for all. 
            Every purchase order transitioned to a small business makes a difference.
        </p>
    </div>
    """, unsafe_allow_html=True)
...
st.markdown("""
<div class="dashboard-card">
    <h1 style="margin: 0; text-align: center; color: var(--poly-green) !important; font-size: 4rem; font-weight: 800; line-height: 1.1; letter-spacing: -0.02em;">Small Business PO Percentage Target</h1>
